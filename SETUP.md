...
PawTrack runs on real hardware as a registered DimOS blueprint:
`pawtrack-agentic`. It is the stock `unitree-go2-agentic` stack plus the
PawTrack skill container and prompt.
